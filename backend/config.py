...
class Config:
    ...
    MAIL_DEFAULT_SENDER = os.environ.get('MAIL_DEFAULT_SENDER', 'noreply@flightfrd.com')
    
    # Email verification token expiration (1 hour)
    EMAIL_VERIFICATION_TOKEN_EXPIRES = timedelta(hours=1)